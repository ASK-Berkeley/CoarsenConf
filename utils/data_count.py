...
def drug_count_local(batch_size = 32, mode = 'train', data_dir='/data/torsional_diffusion/DRUGS/drugs/',
                dataset='drugs', limit_mols=0, log_dir='./test_run', num_workers=16, restart_dir=None, seed=0,
                 split_path='/data/torsional_diffusion/DRUGS/split.npy',
    ...
    data = ConformerDataset(data_dir, split_path, mode, dataset=dataset,
                                   ...
                                   raw_dir='/data/torsional_diffusion/DRUGS/dgl', 
                                   save_dir='/data/torsional_diffusion/DRUGS/dgl',
...
def qm9_count_local(batch_size = 32, mode = 'train', data_dir='/data/torsional_diffusion/QM9/qm9/',
                dataset='drugs', limit_mols=0, log_dir='./test_run', num_workers=16, restart_dir=None, seed=0,
                 split_path='/data/torsional_diffusion/QM9/split.npy',
                 std_pickles=None): #   std_pickles='/data/QM9/standardized_pickles'):
    types = qm9_types
    use_diffusion_angle_def = False
    data = ConformerDataset(data_dir, split_path, mode, dataset=dataset,
                                   ...
                                   pickle_dir=std_pickles,
                                   use_diffusion_angle_def=use_diffusion_angle_def,
                                   raw_dir='/data/torsional_diffusion/QM9/dgl', 
                                   save_dir='/data/torsional_diffusion/QM9/dgl',
                                   boltzmann_resampler=None,
                                   count = True)
